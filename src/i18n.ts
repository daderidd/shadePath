...
const D: Record<string, Entry> = {
  ...
  btn_repair: { fr: "🔧 Réparation la plus proche", en: "🔧 Nearest repair point" },
  ly_bike: { fr: "🔧 Réparation vélo", en: "🔧 Bike repair" },
  poi_repair: { fr: "🔧 Station de réparation libre-service", en: "🔧 Self-service repair station" },
  poi_shop: { fr: "🏪 Magasin de vélo", en: "🏪 Bike shop" },
  poi_pump: { fr: "💨 Pompe à vélo", en: "💨 Bike pump" },
  pin_repair: { fr: "🔧 réparation", en: "🔧 repair" },
  msg_no_repair: { fr: "Aucun point de réparation à proximité.", en: "No repair point nearby." },
